			...
			<div class="parallax_content">
				<div class="detail_holder">
					...
					<div class="detail_desc">
						<form class="" method="get" action="basket.php">
							...
							<p><span class="bold_desc price">Price:</span> Ugx<span id="price"><?php echo (int)$price; ?></span></p>
							...
							<p><span class="bold_desc">Total Price:</span> Ugx<span id="total_price"><?php echo (int)$price; ?></span></p>
							<div class="form_group">
	...
	<div class="content" onclick="remove_class()">
		<div class="inner_content">
			<div class="contact">
				<div class="left">
					<h3>LOCATION</h3>
					<p>Wandegeya, Market</p>
					<p>Kampala</p>
				</div>
				<div class="left">
					<h3>CONTACT</h3>
					<p>0771959423, 07058475012</p>
					<p>austinebrianokolong5@gmail.com</p>
				</div>
				<p class="left"></p>
...
<script>
	function sum_price() {
		...
		let toInt = parseInt(amount);
		toInt = toInt + 1;
		$("#amount").val(toInt);
		let price = $("#price").html();
		let total_price = price * toInt;
